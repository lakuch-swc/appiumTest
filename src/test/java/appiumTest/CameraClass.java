...
public class CameraClass {
	...
	public void openCamera(AppiumDriver<MobileElement> driver) {
	...
	public void takePhoto(AppiumDriver<MobileElement> driver) {
	...
	public void takeVideo(AppiumDriver<MobileElement> driver) {
	...
	public void chooseFromLibrary(AppiumDriver<MobileElement> driver) {
